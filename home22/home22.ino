...
const int num = 21;//количество триггеров
...
#define kotel 0
#define switch_floor1 1
#define prachka 2
#define switch2_floor1 3
#define switch1_kitchen 4
#define switch2_kitchen 5
#define hall_floor1 6
#define switch_input 7
#define street1 8 //switch_street_floor1
#define switch_room3_floor2 9
#define switch_room1_floor2 10
#define floor3 11
#define street2 12//switch_street_floor2
#define wardrobe 13
#define hall_floor2 14
#define sw1_room2_floor2 15
#define sw2_room2_floor2 16
#define bathroom1 17
#define bathroom2 18
#define room1_floor1 19
#define switch2_input 20//switch2_input
...
boolean readHere=digitalRead(pin_num);
      ...
      //написать сюда дополнительные условия
if((tr_num==bathroom1)&&(readHere==0)){
  digitalWrite(fan_bathroom_floor1, 1);
  }
if((tr_num==bathroom2)&&(readHere==0)){

  digitalWrite(fan_bathroom_floor2, 1);

}
//
if((tr_num==bathroom1)&&(readHere==1)){
  started_1=1;
  timer_1=millis();
  }
if((tr_num==bathroom2)&&(readHere==1)){
  started_2=1;
  timer_2=millis();
}
//
...
simply_trigger_it(kotel,light_kotel);
simply_trigger_it(switch_floor1,light_street_floor1);
simply_trigger_it(prachka,light_hall_floor1);
simply_trigger_it(switch2_floor1,light_prachka_floor2);
simply_trigger_it(switch1_kitchen,light_stairs_floor1);
simply_trigger_it(switch2_kitchen,light1_kitchen);
simply_trigger_it(hall_floor1,light2_kitchen_tv);
simply_trigger_it(switch_input,light_hall_floor1);
simply_trigger_it(street1,light_tambur);
simply_trigger_it(switch_room3_floor2,light_street_floor1);
simply_trigger_it(switch_room1_floor2,light_room3_floor2);
simply_trigger_it(floor3,light_room1_floor2);
simply_trigger_it(street2,light1_floor3);
simply_trigger_it(wardrobe,light_street_floor2);
simply_trigger_it(hall_floor2,light_wardrobe_floor2);
simply_trigger_it(sw1_room2_floor2,light_on_stairs);
simply_trigger_it(sw2_room2_floor2,light_room2_floor2);
simply_trigger_it(bathroom1,socket1_floor2);
simply_trigger_it(bathroom2,light_bathroom_floor1);
simply_trigger_it(room1_floor1,light_bathroom_floor2);
