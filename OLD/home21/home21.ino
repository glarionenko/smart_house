...
if((tr_num==badroom1)&&(readHere==0)){
  digitalWrite(fan_badroom_floor1, 1);
  }
if((tr_num==badroom2)&&(readHere==0)){

  digitalWrite(fan_badroom_floor2, 1);

}
//
if((tr_num==badroom1)&&(readHere==1)){
  started_1=1;
  timer_1=millis();
  }
if((tr_num==badroom2)&&(readHere==1)){
  started_2=1;
  timer_2=millis();
}
//
...
simply_trigger_it(badroom1,socket1_floor2);
simply_trigger_it(badroom2,light_badroom_floor1);
simply_trigger_it(room1_floor1,light_badroom_floor2);
